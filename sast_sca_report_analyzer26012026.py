...
SMTP_SERVER = 'email-smtp.us-west-2.amazonaws.com'  # Example: 'smtp.gmail.com', 'smtp.office365.com', or your local SMTP server
...
SMTP_USERNAME = 'AKIAZYPVMIKQ4L77ZYKB'  # Email username (leave empty for anonymous)
SMTP_PASSWORD = 'BOZnZAJ9s2t7E/auzcr+isNhu0gu51HkthGqoRWK27n1'  # Email password (leave empty for anonymous)
SMTP_USE_TLS = True  # Set to True for TLS, False for no encryption

# Email settings
#EMAIL_FROM = 'user@mail.com'  # Sender email address
EMAIL_FROM = 'ypingle@hotmail.com'  # Sender email address
